...
public class ScrollingActivityTest {
    ...
    public void scrollingActivityTest() {
        ...
        ViewInteraction button = onView(
                allOf(withText("test7"),
                        withParent(allOf(withId(R.id.scrollingLinLayout),
                                withParent(withId(R.id.include6)))),
                        isDisplayed()));
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewName), withText("test7"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("test7")));
